...
//			remove(bg);
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') { 
			...
			scoreTxt.text = 'Score: ' + songScore + ' | Port By Nael1820 | Misses: ' + songMisses + ' | Rating: ' + ratingName + ' (' + Highscore.floorDecimal(ratingPercent * 100, 2) + '%)' + ' - ' + ratingFC;//peeps wanted no integer rating
		}
